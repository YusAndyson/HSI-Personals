    ...
    ?>
        <div class='col-10 m-auto' style='padding: 100px 0 0 0'>
            ...
            <div class='col-md-8 m-auto p-5 shadow p-3 mb-5 bg-body rounded'>
                <form action="swr-proses.php" method='post'>
                    <div class='mb-3'>
                    ...
                    <div>
                        <label for="exampleForControlInput1" class='form-label'>Software Services</label> <br>
                        <select name="service" id="">
                            <option value="">--Select--</option>
                            <option value="web">Web</option>
                            <option value="cv">CV / ID Card</option>
                    ...
                    <div class='mb-3'>
                        ...
                        <textarea name="massage" class="form-control"  id='exampleForControlInput1'></textarea>
                    </div>
