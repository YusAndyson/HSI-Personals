...
<head>
    ...
    <title>HumanSyNTax; - Admin/Hardware</title>
...
<body>
    ...
    <div class="sidebar">
      ...
      <a href="./hardware.php" class="active">
  ...
  <div class="container">
        <div class='col-10 m-auto'>
            <h1 style="font-family: 'Antonio', sans-serif;">Hardware Pesan</h1>
                ...
                <tbody>
                    <tr>
                        ...
                        <td scope='row'>
                          ...
                          <a href="./hardware-edit.php?id=<?= $data['id']?>" class="btn btn-warning">Edit</a>
                        </td>
                    </tr>
                </tbody>
                <?php
